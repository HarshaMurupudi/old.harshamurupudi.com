...
Command: npx gltfjsx@6.1.4 ./public/models/pirate-raft-world-v2.glb
*/

import React, { useRef } from 'react';
import { useGLTF } from '@react-three/drei';

export function WorldV2(props) {
  const { nodes, materials } = useGLTF('./models/pirate-raft-world-v2.glb');
  return (
...
useGLTF.preload('./models/pirate-raft-world-v2.glb');
