        ...
        <div className='grid grid-cols-2 gap-12 place-content-center'>
          <div className='p-6'>
            ...
            <p class='mb-3 font-normal text-gray-900 dark:text-gray-400'>
              ...
              (developer experience). With some cultural analysis, writing, and
              visual illustration sprinkled on top.{' '}
            </p>
            <p class='mb-3 font-normal text-gray-900 dark:text-gray-400'>
              I currently lead design at Oughtwhere we're exploring how machine
              learning can help researchers with open-ended reasoning.
            </p>
            <p class='mb-3 font-normal text-gray-900 dark:text-gray-400'>
              I'm not currently available for any contract work, side projects,
              or full-time roles.
            </p>
